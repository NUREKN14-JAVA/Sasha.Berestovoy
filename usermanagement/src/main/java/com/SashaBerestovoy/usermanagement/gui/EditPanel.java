...
//	private java.util.Date dateOfBirth;
	...
	private void initialize() {
		...
		try {
			...
			DateFormat df = new SimpleDateFormat(Messages.getString("EditPanel.6")); //$NON-NLS-1$
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(Messages.getString("EditPanel.7").equalsIgnoreCase(e.getActionCommand())){  //$NON-NLS-1$
			...
			try {
				...
				JOptionPane.showMessageDialog(this, e1.getMessage(), Messages.getString(Messages.getString("EditPanel.8")), JOptionPane.ERROR_MESSAGE);  //$NON-NLS-1$
			}
		}
		clearFields();
		this.setVisible(false);
	...
	private void clearFields() {
		getFirstNameField().setText(Messages.getString("EditPanel.9"));  //$NON-NLS-1$
		//getFirstNameField().setBackground(bgColor);
		
		getLastNameField().setText(Messages.getString("EditPanel.10"));  //$NON-NLS-1$
		//getLastNameField().setBackground(bgColor);
		
		getDateOfBirthField().setText(Messages.getString("EditPanel.11"));  //$NON-NLS-1$
