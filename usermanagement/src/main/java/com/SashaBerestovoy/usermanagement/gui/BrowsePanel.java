...
public class BrowsePanel extends JPanel implements ActionListener {
	...
	private JButton getEditButton() {
		if(editButton == null){
			...
			editButton.setText(Messages.getString("change")); //$NON-NLS-1$
	...
	public void initTable() {
		...
		try {
			...
			JOptionPane.showMessageDialog(this, e.getMessage(), Messages.getString("BrowsePanel.1"), JOptionPane.ERROR_MESSAGE); //$NON-NLS-1$
		}
